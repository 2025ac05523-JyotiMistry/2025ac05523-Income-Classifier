...
- **After Preprocessing**: 30,162 instances (removed rows with missing values marked as '?')
...
|---------------|--------------------------------------|
| Logistic Regression | **Strong overall performer** with 85.43% accuracy and excellent AUC of 0.9136. Shows good balance between precision (75.02%) and recall (62.18%). MCC of 0.5911 indicates substantial correlation. Linear model works well due to linearly separable patterns in the data. Best performing linear model with strong ranking capability. |
